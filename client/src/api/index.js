...
export const getArchivedSystems = id => api3.get(`/system/${id}`)
...
export const getArchivedSubtasks = id => api4.get(`/subtask/${id}`)
...
export const getArchivedTasks = id => api5.get(`/task/${id}`)
...
export const getArchivedFindings = id => api6.get(`/finding/${id}`)
